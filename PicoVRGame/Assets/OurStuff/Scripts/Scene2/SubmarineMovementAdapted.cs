...
public class SubmarineMovementAdapted : MonoBehaviour
{
    ...
    [SerializeField] private LeftRightLever leftRightLever;
    ...
    private void FixedUpdate()
    {
        ...
        {
            submarineGO.GetComponent<Rigidbody>().AddRelativeTorque(new Vector3(0, leftRightLever.leftRightTilt * speed * Time.fixedDeltaTime, 0));
        }
